...
npm run test                # Run 640 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (965) + Vitest (640) + Cypress (9 E2E spec) |
...
- Frontend: 640 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
