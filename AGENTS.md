...
mvn -B test -q             # Run 1040 tests (H2 in-memory)
...
| Tests | JUnit 5 (1040) + Vitest (695) + Cypress (9 E2E spec) |
...
- Backend: 1040 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
