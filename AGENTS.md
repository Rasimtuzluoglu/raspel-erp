...
mvn -B test -q             # Run 994 tests (H2 in-memory)
...
| Tests | JUnit 5 (994) + Vitest (672) + Cypress (9 E2E spec) |
...
- Backend: 994 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
