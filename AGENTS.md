...
mvn -B test -q             # Run 978 tests (H2 in-memory)
...
| Tests | JUnit 5 (978) + Vitest (670) + Cypress (9 E2E spec) |
...
- Backend: 978 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
