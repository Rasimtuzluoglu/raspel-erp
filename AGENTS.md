...
mvn -B test -q             # Run 795 tests (H2 in-memory)
...
npm run test                # Run 157 tests (Vitest)
npm run lint                # ESLint
...
| Tests | JUnit 5 (795) + Vitest (157) + Cypress |
...
- Backend: 795 tests (JUnit 5, H2, Mockito), must pass before commit
- Frontend: 157 tests (Vitest), zero ESLint warnings required
