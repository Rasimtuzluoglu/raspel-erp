...
mvn -B test -q             # Run 983 tests (H2 in-memory)
...
| Tests | JUnit 5 (983) + Vitest (670) + Cypress (9 E2E spec) |
...
- Backend: 983 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
