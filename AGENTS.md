...
npm run test                # Run 619 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (965) + Vitest (619) + Cypress (7 E2E spec) |
...
- Frontend: 619 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
