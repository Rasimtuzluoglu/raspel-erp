...
mvn -B test -q             # Run 974 tests (H2 in-memory)
...
| Tests | JUnit 5 (974) + Vitest (670) + Cypress (9 E2E spec) |
...
- Backend: 974 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
