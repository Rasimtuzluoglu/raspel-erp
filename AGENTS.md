...
npm run test                # Run 634 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (965) + Vitest (634) + Cypress (9 E2E spec) |
...
- Frontend: 634 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
