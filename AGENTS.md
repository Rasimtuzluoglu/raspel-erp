...
npm run test                # Run 662 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (969) + Vitest (662) + Cypress (9 E2E spec) |
...
- Frontend: 662 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
