...
npm run test                # Run 633 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (965) + Vitest (633) + Cypress (9 E2E spec) |
...
- Frontend: 633 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
