...
mvn -B test -q             # Run 1150 tests (H2 in-memory)
...
| Tests | JUnit 5 (1150) + Vitest (720) + Cypress (9 E2E spec) |
...
- Backend: 1150 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
