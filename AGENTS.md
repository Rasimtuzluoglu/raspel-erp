...
npm run test                # Run 691 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (1033) + Vitest (691) + Cypress (9 E2E spec) |
...
- Frontend: 691 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
