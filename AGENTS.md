...
mvn -B test -q             # Run 1143 tests (H2 in-memory)
...
| Tests | JUnit 5 (1143) + Vitest (717) + Cypress (9 E2E spec) |
...
│   ├── components/            # 52 shared components
...
- Backend: 1143 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
