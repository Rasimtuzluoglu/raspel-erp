...
npm run test                # Run 695 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (1033) + Vitest (695) + Cypress (9 E2E spec) |
...
- Frontend: 695 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
