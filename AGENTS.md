...
npm run test                # Run 677 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (1015) + Vitest (677) + Cypress (9 E2E spec) |
...
- Frontend: 677 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
