...
mvn -B test -q             # Run 1145 tests (H2 in-memory)
...
| Tests | JUnit 5 (1145) + Vitest (720) + Cypress (9 E2E spec) |
...
- Backend: 1145 tests (JUnit 5, H2, Mockito) + JaCoCo coverage gate, must pass before commit
