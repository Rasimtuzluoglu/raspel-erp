...
npm run test                # Run 651 tests (Vitest) + coverage gate
npm run lint                # ESLint
...
| Tests | JUnit 5 (969) + Vitest (651) + Cypress (9 E2E spec) |
...
- Frontend: 651 tests (Vitest) + coverage gate, zero ESLint warnings required; `npm run i18n:check` clean
