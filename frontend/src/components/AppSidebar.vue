  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-alt">
      <div class="sidebar-alt-ust">
        <div class="sidebar-arama" @click="$emit('open-search')" title="Hızlı Ara (Ctrl+K)">
        ...
        <div class="kullanici-kart">
          ...
          <Button icon="pi pi-lock" class="p-button-rounded p-button-text sifre-btn" @click="$emit('open-password-modal')" title="Şifre Değiştir" />
