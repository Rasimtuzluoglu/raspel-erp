    ...
    try {
      const [
        ...
        belgeAPI
          ...
          .then((r) =>
            (r.data || [])
              .filter((b) => icindeAra(b.dosyaAdi, q) || icindeAra(b.entityAdi, q))
              .slice(0, 3)
              .map((d) => ({
                ...d,
                type: 'belge',
