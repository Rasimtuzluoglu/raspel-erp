...
const adimlar = reactive([
  ...
  { baslik: 'İlk Cari Hesabını Ekleyin', aciklama: 'Müşteri ve tedarikçilerinizi sisteme ekleyin.', buton: 'Cari Ekle', ikon: 'pi pi-users', tamam: false, path: '/cari-hesaplar' },
  { baslik: 'Ürünlerinizi Tanımlayın', aciklama: 'Stok ürünlerinizi, fiyatlarını ve birimlerini ekleyin.', buton: 'Stok Ekle', ikon: 'pi pi-box', tamam: false, path: '/stoklar' },
  { baslik: 'İlk Faturanızı Kesin', aciklama: 'Satış veya alış faturanızı oluşturun.', buton: 'Fatura Kes', ikon: 'pi pi-file', tamam: false, path: '/faturalar' }
])
...
const demoYukle = async () => {
  ...
  try {
    ...
    const ornekStoklar = [
      { ad: 'MDF 18mm', stokKodu: 'MDF-18', barkod: '8690001', birim: 'Adet', fiyat: 850, satisFiyati: 1050, miktar: 100, minMiktar: 10 },
      { ad: 'PVC Bant Beyaz', stokKodu: 'PVC-B01', barkod: '8690002', birim: 'Rulo', fiyat: 45, satisFiyati: 75, miktar: 200, minMiktar: 20 },
      { ad: 'Sunta 16mm', stokKodu: 'SUNTA-16', barkod: '8690003', birim: 'Adet', fiyat: 520, satisFiyati: 690, miktar: 80, minMiktar: 10 }
    ]
...
.onboard-ust { text-align: center; margin-bottom: 2rem; }
.onboard-ikon { font-size: 3rem; color: #3b82f6; margin-bottom: 0.5rem; }
.onboard-ust h2 { margin: 0 0 0.5rem; font-size: 1.4rem; }
.onboard-ust p { color: var(--text-secondary); font-size: 0.9rem; margin: 0; }
.onboard-adimlar { display: flex; flex-direction: column; gap: 1rem; margin-bottom: 2rem; }
.adim { display: flex; gap: 1rem; align-items: flex-start; }
.adim-no {
  width: 32px; height: 32px; border-radius: 50%; flex-shrink: 0;
  display: flex; align-items: center; justify-content: center;
  background: rgba(59,130,246,0.15); color: #60a5fa; font-weight: 700; font-size: 14px;
}
.adim-no.adim-yesil { background: rgba(34,197,94,0.15); color: #4ade80; }
.adim-icerik { flex: 1; }
.adim-icerik strong { font-size: 0.95rem; }
.adim-icerik p { font-size: 0.85rem; color: var(--text-secondary); margin: 2px 0 8px; }
.onboard-alt {
