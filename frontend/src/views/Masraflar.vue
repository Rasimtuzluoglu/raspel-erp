<template>
  <div class="masraf-container">
    <div class="sayfa-baslik">
      <h1 class="page-title">Masraf Takibi</h1>
      <Button label="Yeni Masraf" icon="pi pi-plus" @click="dialogAc()" />
    </div>
    ...
    <DataTable :value="list" stripedRows :loading="yukleniyor">
      ...
      <Column field="belgeNo" header="Belge No" />
    ...
    <Dialog v-model:visible="dialog" :header="dialogHeader" modal :style="{ width: '500px' }">
      <div class="form-grid">
        ...
        <div class="field"><label>Kategori</label><InputText v-model="form.kategori" class="w-full" /></div>
        ...
        <div class="field"><label>Belge No</label><InputText v-model="form.belgeNo" class="w-full" /></div>
      </div>
      <template #footer>
