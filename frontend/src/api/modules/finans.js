...
export const bankaAPI = {
  getAll() { return apiClient.get('/bankalar') },
  getById(id) { return apiClient.get(`/bankalar/${id}`) },
  create(data) { return apiClient.post('/bankalar', data) },
  update(id, data) { return apiClient.put(`/bankalar/${id}`, data) },
  delete(id) { return apiClient.delete(`/bankalar/${id}`) }
}
