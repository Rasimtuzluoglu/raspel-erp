...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 965 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (619 test, coverage gate dahil)
