...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 1143 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (717 test, coverage gate dahil)
