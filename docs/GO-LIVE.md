...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 1033 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (691 test, coverage gate dahil)
