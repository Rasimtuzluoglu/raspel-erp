...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 969 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (651 test, coverage gate dahil)
