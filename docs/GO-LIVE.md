...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 1015 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (678 test, coverage gate dahil)
