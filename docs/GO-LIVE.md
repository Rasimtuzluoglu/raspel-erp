...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 1047 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (687 test, coverage gate dahil)
