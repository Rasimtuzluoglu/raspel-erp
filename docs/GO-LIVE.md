...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 1013 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (674 test, coverage gate dahil)
