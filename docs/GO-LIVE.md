...
- [ ] Backend testleri gecti (`mvn -B clean verify` -> 1081 test, JaCoCo gate dahil)
- [ ] Frontend build alindi (`npm run build`) ve lint/test temiz (710 test, coverage gate dahil)
